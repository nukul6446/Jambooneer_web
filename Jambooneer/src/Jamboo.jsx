...
/* =========================================================
   IMAGES
   NOTE: bottle (product2.png) currently shows "kaiyo" branding.
   Replace with real Jambooneer-branded packaging.
========================================================= */
...
export default function Jamboo() {
  ...
  /* BACKEND CONNECTED FORM SUBMISSION */
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      heroIntro
        ...
        .to(
          ".hero-bottle",
          { opacity: 1, scale: 1, y: 0, rotate: 0, duration: 1.4, ease: "expo.out" },
          "-=1.2"
        );
      ...
      ScrollTrigger.create({
        ...
        onEnter: () => {
          gsap.to(nav.current, { y: 8, scale: 0.97, duration: 0.4, ease: "power3.out" });
        },
        onLeaveBack: () => {
          gsap.to(nav.current, { y: 0, scale: 1, duration: 0.4, ease: "power3.out" });
        },
      });
      ...
      gsap.fromTo(
        ...
        { scaleY: 0 },
        {
          ...
          transformOrigin: "top",
          ease: "none",
          scrollTrigger: { trigger: ".quality-process", start: "top 70%", end: "bottom 65%", scrub: 1 },
        }
      );
      ...
      gsap.utils.toArray(".quality-item").forEach((item) => {
        gsap.fromTo(
          ...
          { opacity: 0.55, x: 30 },
          {
            ...
            duration: 0.7,
            ease: "power3.out",
            scrollTrigger: { trigger: item, start: "top 72%", end: "top 42%", scrub: true },
          }
        );
      });
      ...
      gsap.utils.toArray(".counter").forEach((counter) => {
        ...
        gsap.to(obj, {
          ...
          onUpdate: () => {
            counter.innerText = Math.floor(obj.value).toLocaleString("en-IN") + "+";
          },
        });
      });
      ...
      gsap.fromTo(
        ...
        { scaleX: 0 },
        {
          ...
          ease: "none",
          scrollTrigger: { trigger: ".process-section", start: "top 70%", end: "bottom 65%", scrub: 1 },
        }
      );
      ...
      /* Custom cursor — hidden until mouse moves */
      ...
      const onMouseLeave = () => {
        gsap.to([cursor.current, cursorDot.current], { opacity: 0, duration: 0.3 });
      };
      ...
      gsap.utils.toArray(".magnetic").forEach((button) => {
        const move = (e) => {
          ...
          gsap.to(button, { x: x * 0.22, y: y * 0.22, duration: 0.35, ease: "power3.out" });
        };
        const leave = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ".mobile-link",
        { opacity: 0, y: 40 },
        { opacity: 1, y: 0, duration: 0.7, stagger: 0.08, delay: 0.15, ease: "power4.out" }
      );
    });
    return () => ctx.revert();
  }, [menuOpen]);
  ...
  return (
    <main ref={main} className="relative overflow-hidden bg-[#FAF5FB] text-[#2d0a4e]">
      {/* SPA fallback */}
      <noscript>
        <div style={{ padding: "2rem", textAlign: "center", background: "#2d0a4e", color: "white" }}>
          <h1>Jambooneer</h1>
  ...
  <img 
    src={logo} 
    alt="Jambooneer logo" 
    className="w-[290px] h-[145px] object-contain" 
  />
</div>
          </a>
      ...
      {menuOpen && (
        <div className="mobile-menu fixed inset-0 z-[90] flex flex-col justify-end bg-[#2d0a4e] px-7 pb-10 pt-32 text-white">
          ...
          <div className="mt-8 text-xs uppercase tracking-[0.3em] text-white/40">Pure water. Honest delivery.</div>
        </div>
      )}

      {/* HERO */}
      <section ref={hero} id="home" className="hero relative flex min-h-[900px] items-center overflow-hidden bg-[#F3E5F5] pt-28">
        ...
        <div className="hero-copy-area relative z-20 mx-auto grid w-full max-w-7xl items-center gap-12 px-6 pb-28 md:px-10 lg:grid-cols-[1fr_0.65fr]">
          <div>
            ...
            <p className="hero-copy mt-9 max-w-xl text-sm leading-7 text-[#5e2a7e] md:text-base">
              Jambooneer brings rigorously purified, mineral-balanced water straight to your
              home, office, or event — clean water, honest delivery, every single time.
            </p>
            ...
            <div className="hero-stats mt-14 grid max-w-2xl grid-cols-2 border-y border-[#2d0a4e]/10 py-5 sm:grid-cols-4">
              {[
                ...
                <div key={label} className="border-r border-[#2d0a4e]/10 px-4 first:pl-0 last:border-0">
                  <div className="flex items-end gap-0.5 text-2xl font-black tracking-tight text-[#2d0a4e]">
                    <span className="counter" data-value={value}>0+</span>
                  </div>
                  <div className="mt-1 text-[8px] font-bold uppercase tracking-[0.15em] text-[#7e57a2]">{label}</div>
                </div>
              ))}
            </div>

            <div className="hero-proof mt-6 flex flex-wrap gap-x-5 gap-y-2 text-[13px] font-bold uppercase tracking-[0.18em] text-[#7e57a2]">
              <span>FSSAI Certified</span><span>•</span>
              <span>ISI Certified</span><span>•</span>
              <span>Same-Day Delivery</span><span>•</span>
          ...
          <div ref={bottleWrap} className="pointer-events-none relative flex min-h-[500px] items-center justify-center">
            ...
            <div ref={bottle} className="hero-bottle relative z-10 w-[170px] transform-gpu sm:w-[200px] md:w-[235px] lg:w-[260px]" style={{ transformStyle: "preserve-3d" }}>
              <img src={IMAGES.bottle} alt="Jambooneer premium water bottle" className="h-auto w-full rounded-[30px] object-cover shadow-[0_45px_80px_rgba(45,10,78,0.25)]" />
        ...
        <div className="absolute bottom-8 left-1/2 z-30 flex -translate-x-1/2 flex-col items-center gap-3">
          <span className="text-[8px] font-bold uppercase tracking-[0.4em] text-[#7e57a2]">Explore the journey</span>
          ...
          <div className="grid items-center gap-20 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="reveal relative">
              ...
              <div className="relative h-[520px] overflow-hidden rounded-[32px]">
                ...
                <div className="absolute bottom-7 left-7 right-7 flex items-end justify-between text-white">
                  <div>
                    <div className="text-[9px] font-bold uppercase tracking-[0.3em] text-white/60">Our Beginning</div>
                    <div className="mt-2 text-2xl font-light">Where every drop<br />has a purpose.</div>
                  </div>
            ...
            <div>
              <div className="mb-5 flex items-center gap-3">
                ...
                <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#6A1B9A]">Our Story</span>
              </div>
              <div className="overflow-hidden">
                <h2 className="section-title-line text-5xl font-light leading-[0.95] tracking-[-0.05em] text-[#2d0a4e] md:text-7xl">
                  Where Every Drop<br /><span className="font-black">Has a Purpose.</span>
                </h2>
              </div>
              ...
              <div className="mt-12 grid gap-4 sm:grid-cols-3">
                {[
                  ["01", "Pure at the Source", "Multi-stage RO + UV + mineral balancing."],
                  ["02", "Sustainable by Design", "Reusable jars and eco-conscious packaging."],
                  ["03", "Lab-Verified, Always", "200+ safety and quality parameters."],
                  ...
                  >
                    <div className="text-[9px] font-black tracking-[0.2em] text-[#9C27B0]">{number}</div>
                    <h3 className="mt-5 text-sm font-black text-[#2d0a4e]">{title}</h3>
                    <p className="mt-2 text-xs leading-5 text-[#7e5a8e]">{text}</p>
                  </div>
                ))}
              </div>
            </div>
...
>
  <div className="mx-auto max-w-7xl">
    ...
    <div className="products-grid grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="grid gap-20 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="lg:sticky lg:top-32 lg:h-fit">
              <div className="mb-5 flex items-center gap-3">
                ...
                <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#CE93D8]">Why Jambooneer</span>
              </div>
              <div className="overflow-hidden">
                <h2 className="section-title-line text-5xl font-light leading-[0.95] tracking-[-0.05em] md:text-7xl">
                  Trust,<br /><span className="font-black">Engineered.</span>
                </h2>
              </div>
              ...
              <div className="mt-12 flex flex-wrap gap-2">
                {["FSSAI Certified", "ISI Mark", "ISO 9001:2015", "NABL Tested"].map((item) => (
                  <span key={item} className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-[8px] font-bold uppercase tracking-[0.15em] text-white/60">
                    {item}
                  </span>
                ))}
              </div>
            ...
            <div className="quality-process relative">
              ...
              <div className="grid gap-14">
                {[
                  ["01", "Multi-Stage Purification", "Sediment → RO → UV → UF → Minerals → Ozonation → Final QC Check."],
                  ["02", "Same-Day Delivery", "Order before cutoff, receive it the same day. No delays, no excuses."],
                  ["03", "Transparent Quality Reports", "Regular lab reports shared openly with our subscribers — nothing hidden."],
                  ["04", "Support That Never Sleeps", "WhatsApp, call, or email — we're always one message away."],
                  ["05", "A Commitment Beyond the Bottle", "Our reusable jar system keeps thousands of plastic bottles out of landfills every month."],
                ].map(([number, title, text]) => (
                  <div key={number} className="quality-item relative grid grid-cols-[45px_1fr] gap-7">
                    ...
                    <div className="pb-5">
                      ...
                      <p className="mt-4 max-w-xl text-sm leading-7 text-white/50">{text}</p>
                    </div>
                  </div>
                ))}
              </div>
              <div className="mt-20 grid grid-cols-2 gap-px overflow-hidden rounded-[25px] border border-white/10 bg-white/10 sm:grid-cols-4">
                {[
                  ...
                  <div key={label} className="bg-[#2d0a4e] p-6 text-center">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mb-5 flex items-center justify-center gap-3">
              <span className="h-px w-10 bg-[#9C27B0]" />
              <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#6A1B9A]">How It Works</span>
              <span className="h-px w-10 bg-[#9C27B0]" />
            </div>
            <div className="overflow-hidden">
              <h2 className="section-title-line text-5xl font-light leading-none tracking-[-0.05em] text-[#2d0a4e] md:text-7xl">
                Pure Water.<br /><span className="font-black">Four Simple Steps.</span>
              </h2>
            </div>
          </div>
            ...
            <div className="grid gap-8 md:grid-cols-4">
              {processSteps.map((step) => (
                ...
                >
                  ...
                  <h3 className="mt-10 text-xl font-black tracking-tight text-[#2d0a4e]">{step.title}</h3>
                  <p className="mt-4 text-xs leading-6 text-[#7e5a8e]">{step.text}</p>
      ...
      <section className="testimonials-section relative overflow-hidden bg-[#F3E5F5] py-32 md:py-44">
        <div className="px-6 md:px-10">
          <div className="mx-auto max-w-7xl">
            <div className="mb-16">
              <div className="mb-5 flex items-center gap-3">
                <span className="h-px w-10 bg-[#9C27B0]" />
                <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#6A1B9A]">Customer Voices</span>
              </div>
              <div className="overflow-hidden">
                <h2 className="section-title-line text-5xl font-light leading-none tracking-[-0.05em] text-[#2d0a4e] md:text-7xl">
                  Loved by Homes,<br /><span className="font-black">Offices & Celebrations.</span>
                </h2>
              </div>
            </div>
          </div>
        ...
        <div className="testimonial-track flex w-max gap-5 px-6 md:px-10">
          {[...testimonials, ...testimonials].map((item, index) => (
            ...
            >
              <div className="text-xl tracking-[0.2em] text-[#9C27B0]">★★★★★</div>
              <p className="mt-7 text-lg font-light leading-7 text-[#5e2a7e]">"{item.quote}"</p>
              <div className="mt-10 border-t border-[#2d0a4e]/10 pt-5">
                <div className="text-sm font-black text-[#2d0a4e]">{item.name}</div>
                <div className="mt-1 text-[9px] font-bold uppercase tracking-[0.15em] text-[#7e57a2]">{item.role}</div>
              </div>
            </article>
          ))}
        </div>
      ...
      {/* CONTACT */}
      <section id="contact" className="contact-section relative overflow-hidden bg-[#2d0a4e] px-6 py-32 text-white md:px-10 md:py-44">
          ...
          <div className="grid gap-20 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="contact-info">
              <div className="contact-kicker mb-5 flex items-center gap-3">
                <span className="h-px w-10 bg-[#CE93D8]" />
                <span className="text-[11px] font-bold uppercase tracking-[0.3em] text-[#CE93D8]">Get In Touch</span>
              </div>
              <h2 className="contact-heading text-5xl font-light leading-[0.95] tracking-[-0.05em] md:text-7xl">
                Let's Start<br /><span className="font-black">Your Pure Water</span><br />Journey.
              </h2>
              ...
              <div className="mt-12 grid gap-6">
                <div className="flex items-start gap-4">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white/5 text-[#CE93D8]"><FiMapPin /></span>
                  <div>
                    <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/30">Location</div>
                    <div className="mt-2 text-sm text-white/70">{CONTACT_ADDRESS}</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white/5 text-[#CE93D8]"><FiPhone /></span>
                  <div>
                    <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/30">Phone</div>
                    <div className="mt-2 text-sm text-white/70">{CONTACT_PHONE}</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white/5 text-[#CE93D8]"><FiMail /></span>
                  <div>
                    <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/30">Email</div>
                    <div className="mt-2 text-sm text-white/70">{CONTACT_EMAIL}</div>
                  </div>
                </div>
                  <div className="flex items-start gap-4">
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white/5 text-[#CE93D8]"><FiClock/></span>
                  <div>
                    <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/30">  Office Hours</div>
                    <div className="mt-2 text-sm text-white/70">{OFFICE_HOURS}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <div className="mb-8">
                <div className="text-[9px] font-bold uppercase tracking-[0.25em] text-[#CE93D8]">Request a Dealership / Enquiry</div>
                <h3 className="mt-3 text-2xl font-black">Tell us what you need.</h3>
              </div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  <label htmlFor="message" className="sr-only">Your Requirement</label>
                  <textarea
                    id="message"
                    name="message"
              ...
              <p className="mt-5 text-[15px] leading-5 text-white/30">
  ...
  />
              ...
              <p className="mt-7 max-w-sm leading-6 text-[19px] text-white/40">
                Pure water delivered with care, straight to your doorstep.
              </p>
            </div>
            <div className="footer-reveal">
              <div className="text-[19px] font-black uppercase tracking-[0.25em] text-[#CE93D8]">Products</div>
            ...
            <div className="footer-reveal">
              <div className="text-[19px] font-black uppercase tracking-[0.25em] text-[#CE93D8]">Company</div>
              <div className="mt-5 grid gap-3 text-[15px] text-white/45">
                <button onClick={() => scrollTo("about")} className="text-left">About Us</button>
                <button onClick={() => scrollTo("why-us")} className="text-left">Why Choose Us</button>
                <button onClick={() => scrollTo("process")} className="text-left">How It Works</button>
